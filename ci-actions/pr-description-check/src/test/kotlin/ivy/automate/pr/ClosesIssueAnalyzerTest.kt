    ...
    enum class PRDescTestCase(
        ...
        VALID_SHORT_1(
            prDescription = """
                ...
                - [x] I've read the [Contribution Guidelines](https://github.com/rafaeltonholo/ivy-wallet/blob/main/CONTRIBUTING.md) and my PR doesn't break the rules.
                - [x] I've read and understand the [Developer Guidelines](https://github.com/rafaeltonholo/ivy-wallet/blob/main/docs/Guidelines.md).
        ...
        INVALID_DEFAULT_TEMPLATE(
            prDescription = """
                ...
                **In what cases won't your code work?**
                ...
                <!--💡 Tip: Replace {ISSUE_NUMBER} with the number of Ivy Wallet ISSUE (https://github.com/rafaeltonholo/ivy-wallet/issues)(❗NOT PR❗) which this pull request fixes. If done correctly, you'll see the issue title linked on PR preview. 💡-->
                <!--💡 Tip: Multiple issues:
